...
Item {
    ...
    property var rate_Product0: [ 0,0,1,10,1,0,100,255,1,800,100,1,0,0,1,0,0,1,0 ]
	property color test_testColorRgbF: "#ff7f7f33"
    property var rate_Product1: [ 1,0,1,10,1,0,100,255,1,800,100,1,0,0,1,0,0,1,0 ]
    property var rate_Product2: [ 2,0,1,10,1,0,100,255,1,800,100,1,0,0,1,0,0,1,0 ]
    property var rate_Product3: [ 3,0,1,10,1,0,100,255,1,800,100,1,0,0,1,0,0,1,0 ]
}
