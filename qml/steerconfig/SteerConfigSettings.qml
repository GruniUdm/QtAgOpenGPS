        ...
        Item{
            ...
            ColumnLayout{
                ...
                ComboBoxCustomized {
                    id: cboxMotorDrive
                    editable: true
                    // Component.onCompleted: currentIndex = ((Settings.ardSteer_setting0 & 16) == 0) ? 1 : 0
                    model: ListModel {
                        id: modelmotorDriver
                ...
                ComboBoxCustomized {
                    id: cboxConv
                    editable: true
                    // Component.onCompleted: currentIndex = ((Settings.ardSteer_setting0 & 8) == 0) ? 1 : 0
                    model: ListModel {
                        id: a2Dmodel
                ...
                ComboBoxCustomized {
                    id: cboxXY
                    editable: true
                    // Component.onCompleted: currentIndex = ((Settings.ardSteer_setting1 & 8) == 0) ? 0 : 1
                    model: ListModel {
                        id: imuAxismodel
                        ListElement {text: "X"}
                        ListElement {text: "Y"}
