...
Rectangle{
    ...
    Comp.TopLine{
        id: rcDataTopLine
        onBtnCloseClicked:  rcData.visible  = false
        titleText: qsTr("RC")
    }
    ButtonGroup {
    ...
    RowLayout{
        ...
        Comp.IconButtonColor{
            ...
            colorChecked: "green"
            icon.source: prefix + "/images/caret-2.png"
            implicitHeight: 50 * theme.scaleHeight
            implicitWidth: parent.width /4 - 5 * theme.scaleWidth
            visible: true
        }
        Comp.IconButtonColor{
            ...
            colorChecked: "green"
            icon.source: prefix + "/images/caret-3.png"
            implicitHeight: 50 * theme.scaleHeight
            implicitWidth: parent.width /4 - 5 * theme.scaleWidth
            visible: true
        }
        Comp.IconButtonColor{
            ...
            colorChecked: "green"
            icon.source: prefix + "/images/caret-4.png"
            implicitHeight: 50 * theme.scaleHeight
            implicitWidth: parent.width /4 - 5 * theme.scaleWidth
            visible: true
        }
    ...
    Comp.IconButtonColor{
        ...
        icon.source: prefix + "/images/caret-up.png"
        implicitHeight: 50 * theme.scaleHeight
    ...
    Comp.IconButtonColor{
        ...
        checkable: true
        colorChecked: "lightgray"
        icon.source: prefix + "/images/caret-down.png"
        implicitHeight: 50 * theme.scaleHeight
        implicitWidth: 50 * theme.scaleWidth
