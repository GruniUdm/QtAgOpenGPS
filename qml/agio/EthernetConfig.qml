...
Window {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            StackLayout {
                ...
                ScrollView {
                    ...
                    contentWidth: width
                    contentHeight: configColumn.implicitHeight + 100 * theme.scaleHeight  // Force content height
                    clip: true  // Enable clipping for proper scroll
                    ...
                    GroupBox {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                width: 12 * theme.scaleWidth
                                height: 12 * theme.scaleHeight
                                radius: 6 * theme.scaleWidth
                    ...
                    GroupBox {
                        title: "Network Interfaces Available"
                        Layout.fillWidth: true
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        RowLayout {
                                            ...
                                            Text {
                                                ...
                                                font.pixelSize: 10 * theme.scaleWidth
                                            }
                                        }
                                    }
                                }
                    ...
                    GroupBox {
                        title: "Module Detection & Auto-Configuration"
                        Layout.fillWidth: true
                    ...
                    // End of scrollable content - no filler needed in ScrollView
                    }
                }
                }
                ...
                ColumnLayout {
                    ...
                    // UDP Traffic Section (Phase 6.0.21.7: Renamed GPS → UDP for semantic consistency)
                    GroupBox {
                        title: "UDP Traffic"
                        Layout.fillWidth: true
        ...
        // Phase 6.2.2 - Simplified bottom buttons (only OK)
        RowLayout {
            id: bottomButtons
            anchors.bottom: parent.bottom
