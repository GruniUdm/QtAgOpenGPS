                ...
                double size, bool colorize, QColor color)
{
    ...
    if (settings->value("display/camPitch").value<double>() < -45)
    {
        mvp.rotate(90, 1, 0, 0);
                     ...
                     double x, double y, QString text, double size, bool colorize, QColor color)
{
    ...
    //2d
    if (settings->value("display/camPitch").value<double>() < -58)
    {
    ...
    else
    {
        ...
        {
            mvp.rotate(- settings->value("display/camPitch").value<double>(), 1, 0, 0);
            y *= 0.3;
        }
    }
