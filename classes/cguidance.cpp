                                 ...
                                 )
{
    ...
    double stanleyIntegralGainAB = settings->value("vehicle/stanleyIntegralGainAB").value<double>();
    double sideHillCompFactor = settings->value("as/sideHillCompensation").value<double>();
