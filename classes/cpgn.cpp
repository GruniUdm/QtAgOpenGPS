...
PGN32502::PGN32502() : pgn(QByteArray( "\x80\x81\x7E\xF6\x07\x00\x00\x00\x00\x00\x00\x00\xCC", 13))
{
    loadSettings();
}
...
PGN32500::PGN32500() : pgn(QByteArray( "\x80\x81\x7E\xF4\x0A\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCC", 16))
{
}

PGN32400::PGN32400() : pgn(QByteArray( "\x80\x81\x7E\x90\x0A\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCC", 16))
{
}
